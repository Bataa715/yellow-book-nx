...
export function SearchForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-3xl bg-card/80 backdrop-blur-sm p-3 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-5 gap-2 border">
